...
\item Deplete the fission materials in order to obtain the most realistic neutron flux based on historical use of the reactors;
  \item Verify the calculations by comparison, having the cores of both reactores modelled and simulated with two diferent codes [cite OpenMC and cite Mainz code]
\end{itemize}
